    ...
    <div class="intro-banner disable-gradient">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <img src="{{ asset('images/500_img.png') }}" class="img img-fluid" />
                    <h2 class="text-center mt-2 text-bold"><strong>We're sorry, there was an issue with your request 🙁. <br> Its not you, its us. We're working on it!  </strong></h2>
