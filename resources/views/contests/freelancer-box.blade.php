<div class="freelancer">
    ...
    <div class="freelancer-overview pb-3">
        <div class="freelancer-overview-inner">
            ...
            <div class="freelancer-avatar">
                ...
                <a href="#">
                    <img src="{{ asset(is_null($submission->user->avatar) ? ("images/user-avatar-placeholder.png") : ("storage/avatars/{$submission->user->avatar}")) }}" alt="">
                </a>
            </div>
            ...
            <div class="freelancer-name">
                <h4>
                    <a href="{{ route('account.profile', ["username" => $submission->user->username]) }}" target="_blank">
    ...
    <div class="freelancer-details p-2">
        ...
        <div class="d-flex">
            <a href="{{ route('account.profile', ["username" => $submission->user->username]) }}" target="_blank" class="button button-sliding-icon btn-custom-primary ripple-effect mx-1 text-white" style="flex: 1">
                View Profile
