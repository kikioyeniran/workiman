                    ...
                    @foreach ($category->offer_sub_categories as $sub_category)
                        <li>
                            ...
                            <ul class="dashboard-task-info">
                                <li><strong>0</strong><span>Offers</span></li>
                                <li>
                                    <strong>
                            ...
                            <div class="buttons-to-right always-visible">
                                <a href="#" class="button ripple-effect">
                                    <i class="icon-material-outline-visibility"></i> View Offers
                                </a>
                        ...
                        <form action="{{ route('admin.offers.categories.sub-category') }}" method="post" id="delete-sub-category-{{ $sub_category->id }}" class="d-none">
                            @csrf
                            @method('delete')
                            ...
                            <div class="sign-in-form">
                                ...
                                <div class="popup-tabs-container">
                                    ...
                                    <div class="popup-tab-content" id="tab">
                                        ...
                                        <!-- Form -->
                                        <form method="post" action="{{ route('admin.offers.categories.sub-category') }}" enctype="multipart/form-data">
                                            @csrf
                                            @method('put')
