...
<div class="row">
    ...
    <div class="col-xl-12">
        <div class="dashboard-box margin-top-0">
            ...
            <!-- Headline -->
            <div class="headline">
                <h3><i class="icon-material-outline-assignment"></i> Offer Categories</h3>
            ...
            <div class="content">
                <ul class="dashboard-box-list">
                    @foreach ($categories as $category)
                        <li>
                            <div class="job-listing">
                                <div class="job-listing-details">
                                    <a href="{{ route('admin.offers.categories.show', ['id' => $category->id]) }}" class="job-listing-company-logo">
                                        <img src="{{ asset('_home/images/company-logo-02.png') }}" alt="">
                                    </a>
                                    <div class="job-listing-description">
                                        <h3 class="job-listing-title">
                                            <a href="{{ route('admin.offers.categories.show', ['id' => $category->id]) }}">
                                                {{ $category->title }}
                                            </a>
                                        </h3>
                                        <div class="job-listing-footer">
                                            <ul>
                                                <li>
                                                    ...
                                                    {{ $category->offer_sub_categories->count() }} Sub Categories
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="buttons-to-right">
                                {{-- <a href="{{ route('admin.offers.categories.show', ['id' => $category->id]) }}" class="button green ripple-effect ico" title="Manage" data-tippy-placement="left">
                        ...
                        <form action="{{ route('admin.offers.categories.delete', ['id' => $category->id]) }}" method="post" id="delete-category-{{ $category->id }}" class="d-none">
                            @csrf
                            @method('delete')
                            ...
                            <div class="sign-in-form">
                                ...
                                <div class="popup-tabs-container">
                                    ...
                                    <div class="popup-tab-content" id="tab">
                                        ...
                                        <!-- Form -->
                                        <form method="post" action="{{ route('admin.offers.categories.update', $category->id) }}" enctype="multipart/form-data">
                                            @csrf
                                            {{-- @method('put') --}}
                                            <input type="hidden" name="offer_id" value="{{ $category->id }}">

                                            <input class=" with-border default margin-bottom-20" name="title" placeholder="offer Title" value="{{ $category->title }}" required />

                                            {{-- <input type="number" class=" with-border default margin-bottom-20" name="base_amount" placeholder="Base Amount" value="{{ $offer->base_amount }}" required /> --}}

                                            {{-- <div class="uploadButton margin-top-0">
                                                <input class="uploadButton-input" type="file" accept="image/*" id="upload" name="icon"/>
                                                <label class="uploadButton-button ripple-effect" for="upload">Upload Contest offer Image</label>
