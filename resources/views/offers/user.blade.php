            ...
            @forelse ($offers as $offer)
                <div class="freelancer">
                    ...
                    <div class="freelancer-details">
                        ...
                        <a href="{{ route((!array_key_exists('minimum_designer_level', $offer) ? 'offers.freelancers' : 'offers.project-managers'), ['id' => $offer['id']]) }}" class="button button-sliding-icon ripple-effect">
                            View Offer
