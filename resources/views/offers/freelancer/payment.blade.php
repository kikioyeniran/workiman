                ...
                <div class="col-md-12">
                    ...
                    <nav id="breadcrumbs" class="dark">
                        <ul>
                            ...
                            <li><a href="{{ route('offers.index') }}">Freelancer Offers</a></li>
                            <li>Make Payment</li>
                        </ul>
                    </nav>
                            ...
                            <div class="alert alert-success">
                                <small>
                                    @if ($user)
                                        Hello {{ $user->username }},
                                    @endif
                                    to complete your interest in this offer, please pay specified amount.
                                </small>
                            </div>
...
@section('page_scripts')
    ...
    <script>
        ...
        function saveContestPayment(amount, payment_reference, payment_method) {
            ...
            fetch(`{{ route('offers.freelancers.payment', ['interest' => $interest->id]) }}`, {
                    method: 'post',
                    headers: {
                ...
                .then(async responseJson => {
                    if (responseJson.success) {
                        ...
                        setTimeout(() => {
                            window.location = `${webRoot}offers/freelancers/${responseJson.slug}`;
                        }, 2000)
                    } else {
                        Snackbar.show({
                            text: responseJson.message,
