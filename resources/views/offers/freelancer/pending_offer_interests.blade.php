...
@section('page_content')
    ...
    <div class="container">
        @include('layouts.section-header', ['header' => "{$user->display_name} offers with PENDING interest", 'icon' => 'icon-material-outline-announcement'])
            ...
            @forelse ($interests as $interest)
                ...
                <div class="contest-row-card">
                    <div class="d-flex flex-md-row flex-column">
                        ...
                        @elseif($interest->status == 'active')
                            <div class="status-strip bg-success text-white d-none d-sm-block">
                                {{ $interest->status }}
                            </div>
                        @elseif($interest->status == 'inactive' || $interest->status == 'on hold')
