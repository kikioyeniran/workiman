        ...
        {{-- <form action="{{ route('offers.new') }}" method="post" name="job_form" enctype="multipart/form-data">
            ...
            <div class="row">
                        ...
                        <div class="content with-padding padding-bottom-10">
                            <div class="row">
                                ...
                                <div class="col-xl-12 mb-4">
                                    <form action="{{ route('offer.images') }}" method="POST" id="contest-images-form" class="dropzone" enctype="multipart/form-data">
                                        @csrf
                                ...
                                <div class="col-xl-6 delivery-mode-container">
                                    <div class="submit-field">
                                        <h5>Delivery Mode</h5>
                                        <select class="with-border tippy" name="delivery_mode" data-placeholder="No of designers">
                                            <option value="">-</option>
                                    ...
                                    <div class="submit-field">
                                        ...
                                        <select class="with-border tippy" name="offer_user" data-placeholder="No of designers">
                                            ...
                                            @foreach ($users as $user)
                                                <option value="{{ $user->id }}" data-user="freelancer">{{'@'}}{{ $user->username }}</option>
                                            @endforeach
                                        </select>
                                        <div class="clearfix"></div>
                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-2 col-sm-1">
                                                                <div class="switch-container m-0">
                                                                    <label class="switch">
                                                                        <input type="checkbox" name="addon[]" class="offer-addon ad" data-amount="{{ $addon->amount }}" data-id="{{ $addon->id }}" value="yes">
                ...
                <div class="col-xl-12 mb-5 text-center">
                    <a class="button ripple-effect uplNext big margin-top-30" id="submit-offer-form"><i class="icon-feather-plus"></i> Submit Offer</a>
    ...
    <script>
        ...
        submit_offer_form_btn.on('click', () => {
            ...
            let payload = {
                ...
                nda: $('input.offer-addon[type=checkbox][data-id=4]').is(':checked') ? nda_textarea.val().trim() : ''
            }
            ...
            payload = {...payload, _token, skills, addons}
